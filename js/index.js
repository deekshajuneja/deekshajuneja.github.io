$(window).scroll(function(){
    if($(this).scrollTop()>$('#show-more').position().top){
        $('#menu-list').css({position:'fixed',top:'104px', marginLeft: '80.9%'});
    }else{
        $('#menu-list').css({position:'relative', top: 0, marginLeft: '81.764%'});
    }
});
